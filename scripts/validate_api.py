...
CRITICAL_MODULES = [
    ...
    ("app.models.trending_music", "TrendingMusic model"),
    # ── Services ──
    ...
    ("app.api.content.format_b_routes", "Format B routes"),
    ("app.api.content.format_b_design_routes", "Format B design routes"),
    ...
    ("app.api.analytics.v2_routes", "Analytics V2 routes"),
