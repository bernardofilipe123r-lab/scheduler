 ...
 * Design inspired by Ocoya — minimalist, centered, warm neutrals, clean SaaS
 */
...
import {
  ...
  Sparkles, Shield, ChevronDown, Layers,
  Instagram, Facebook, Youtube, Send,
  CheckCircle2, X, Menu, Zap, Target,
} from 'lucide-react'
          ...
          <div className="flex gap-4">
            ...
            <div className="hidden sm:flex flex-col gap-2 w-10">
              <div className="w-8 h-8 rounded-lg bg-[#F5EDD8] flex items-center justify-center mb-2">
                <span className="text-[7px] font-bold text-zinc-700">VA</span>
              </div>
              {[...Array(5)].map((_, i) => (
...
/* ═══════════════════════════════════════════════════════
   WELCOME PAGE — Ocoya-inspired design
   Warm neutrals, centered layout, generous whitespace
   ═══════════════════════════════════════════════════════ */
...
const FAQS = [
  ...
  },
  {
    ...
    answer: 'Yes. ViralToby is built for multi-brand management. Each brand has its own Content DNA, connected platforms, color scheme, and publishing schedule. Add as many brands as you need — $50/month per brand.',
  },
  {
...
const PLATFORMS = [
  ...
  { name: 'TikTok', icon: null, custom: TikTokIcon, color: '#000000' },
  { name: 'Threads', icon: null, custom: ThreadsIcon, color: '#000000' },
]
  ...
  return (
    <div className="min-h-screen bg-[#fafafa]" style={{ fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
        ...
        <div className="max-w-[1200px] mx-auto px-5 sm:px-8">
          <div className="flex items-center justify-between h-[60px]">
            ...
            <div className="hidden md:flex items-center gap-8">
              <button onClick={() => scrollTo('features')} className="text-[13px] text-zinc-500 hover:text-zinc-900 transition-colors duration-200">Features</button>
              <button onClick={() => scrollTo('how-it-works')} className="text-[13px] text-zinc-500 hover:text-zinc-900 transition-colors duration-200">How It Works</button>
              <button onClick={() => scrollTo('pricing')} className="text-[13px] text-zinc-500 hover:text-zinc-900 transition-colors duration-200">Pricing</button>
              <button onClick={() => scrollTo('faq')} className="text-[13px] text-zinc-500 hover:text-zinc-900 transition-colors duration-200">FAQ</button>
            </div>

            <div className="hidden md:flex items-center gap-3">
              <button
                onClick={() => navigate('/login')}
                className="text-[13px] font-medium text-zinc-600 hover:text-zinc-900 transition-colors px-4 py-2"
              >
                Sign In
              </button>
              <button
                onClick={() => navigate('/login')}
                className="bg-zinc-900 hover:bg-zinc-800 text-white text-[13px] font-medium px-5 py-2 rounded-full transition-all duration-200 hover:shadow-sm"
              >
                Get Started
              </button>
            </div>
            ...
            >
              <div className="px-5 py-4 space-y-1">
                ...
                <div className="pt-3 space-y-2">
                  <button onClick={() => { setMobileMenuOpen(false); navigate('/login') }} className="block w-full text-center px-4 py-2.5 text-[13px] font-medium text-zinc-600 border border-zinc-200 rounded-full">Sign In</button>
                  <button onClick={() => { setMobileMenuOpen(false); navigate('/login') }} className="block w-full text-center px-4 py-2.5 text-[13px] font-medium text-white bg-zinc-900 rounded-full">Get Started</button>
                </div>
              </div>
            </motion.div>
          )}
      ...
      <section className="relative pt-32 sm:pt-40 pb-8 sm:pb-12 px-5 sm:px-8 overflow-hidden">
        {/* Background gradient — Ocoya style warm neutral */}
        ...
        <div className="relative max-w-[1200px] mx-auto text-center">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-zinc-100 border border-zinc-200/60 mb-8">
              ...
              <span className="text-[12px] font-medium text-zinc-600 tracking-wide">Social media content. Using AI.</span>
            </div>
            ...
            <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-center justify-center gap-3">
              <button
                onClick={() => navigate('/login')}
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-zinc-900 hover:bg-zinc-800 text-white text-[14px] font-medium px-7 py-3 rounded-full transition-all duration-200 hover:shadow-md"
              >
                Start Free Trial
              ...
              <button
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 text-zinc-600 hover:text-zinc-900 text-[14px] font-medium px-7 py-3 rounded-full border border-zinc-200 hover:border-zinc-300 hover:bg-white transition-all duration-200"
              >
                See How It Works
              </button>
            </div>
        ...
        <div className="max-w-[1200px] mx-auto">
          <Reveal>
            ...
            <div className="flex flex-wrap justify-center items-center gap-8 sm:gap-14">
              {PLATFORMS.map((p) => {
                const Icon = p.icon || p.custom!
                return (
                  <div key={p.name} className="flex items-center gap-2 text-zinc-400 hover:text-zinc-700 transition-colors duration-300 group">
        ...
        <div className="max-w-[1000px] mx-auto">
          <Reveal>
            <div className="text-center mb-16">
              ...
              <h2 className="text-[28px] sm:text-[40px] font-bold text-zinc-900 tracking-[-0.02em]">
                Up and running in minutes.
              </h2>
              <p className="mt-3 text-[16px] text-zinc-500 max-w-[460px] mx-auto leading-relaxed">
                Three steps to turn your brand identity into a content engine.
              </p>
            </div>
          </Reveal>
            ...
            {[
              {
                ...
                desc: 'Set your niche, tone, audience, topics, and visual style. This becomes your Content DNA.',
                time: '5 min',
              },
              {
                step: '02',
                ...
                desc: 'Toby generates branded reels, shorts, carousels, and posts — all quality-scored.',
                time: '10 min',
              },
              {
                step: '03',
                ...
                desc: 'Content lands on your calendar. Review, tweak, and publish across all platforms.',
                time: 'Ongoing',
              },
            ].map((item, i) => (
            ...
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <Reveal className="order-2 lg:order-1">
                <div className="rounded-[20px] border border-zinc-200/60 bg-[#fafafa] p-5 sm:p-6">
                  <div className="space-y-2.5">
                    {[
                      { title: '5 Morning Habits That Changed Everything', platform: 'Instagram Reel', score: 92, color: 'bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045]' },
                      { title: 'The Protein Myth Nobody Talks About', platform: 'YouTube Short', score: 88, color: 'bg-[#ff0000]' },
                      { title: 'Why 90% of Gym Goals Fail', platform: 'TikTok', score: 85, color: 'bg-zinc-900' },
                    ].map((c) => (
              ...
              <Reveal className="order-1 lg:order-2" delay={0.1}>
                <div>
                  ...
                  <h3 className="text-[22px] sm:text-[28px] font-bold text-zinc-900 tracking-[-0.02em] leading-tight">
                    Content that sounds like you.
                  </h3>
                  <p className="mt-3 text-[15px] text-zinc-500 leading-[1.7]">
                    Every piece of content is shaped by your Content DNA. Quality-scored across 5 dimensions before it reaches your calendar.
                  </p>
            ...
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <Reveal delay={0.1}>
                <div>
                  ...
                  <p className="mt-3 text-[15px] text-zinc-500 leading-[1.7]">
                    Visualize your entire content pipeline. Drag to reschedule, click to edit, publish everywhere with one tap.
                  </p>
                  <ul className="mt-5 space-y-2.5">
            ...
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              ...
              <Reveal className="order-1 lg:order-2" delay={0.1}>
                <div>
                  ...
                  <p className="mt-3 text-[15px] text-zinc-500 leading-[1.7]">
                    Track followers, engagement, and views across every platform. Real-time insights that help you grow.
                  </p>
                  <ul className="mt-5 space-y-2.5">
        ...
        <div className="max-w-[1000px] mx-auto">
          <Reveal>
            <div className="text-center mb-14">
              ...
              <p className="mt-3 text-[16px] text-zinc-500 max-w-[480px] mx-auto leading-relaxed">
                Built to power your creativity, not replace it.
              </p>
            </div>
          </Reveal>
            ...
            {[
              {
                ...
                desc: 'Every piece of content follows your brand guidelines. Tone, topics, audience, visuals — Toby stays within your boundaries.',
              },
              {
                icon: Target,
                title: 'Content your way',
                desc: 'Control captions, visuals, cadence, and platform preferences. Customize everything per brand.',
              },
              {
                icon: Zap,
                title: 'Quality scoring',
                desc: 'Content is scored across 5 dimensions. Only content that meets your quality threshold gets published.',
              },
            ].map((item, i) => (
              <Reveal key={i} delay={i * 0.1}>
        ...
        <div className="max-w-[800px] mx-auto">
          <Reveal>
            <div className="text-center mb-14">
              ...
              <p className="mt-3 text-[16px] text-zinc-500 max-w-[440px] mx-auto">
                Agency-level content creation for a fraction of the cost.
              </p>
            </div>
          </Reveal>
          ...
          <Reveal delay={0.1}>
            <div className="rounded-[20px] border border-zinc-200/60 overflow-hidden">
              <table className="w-full">
                ...
                <tbody>
                  {[
                    { label: 'Monthly cost', old: '$2K — $5K+', toby: '$50/brand' },
                    { label: 'Content/month', old: '15 — 30', toby: 'Unlimited' },
                    { label: 'Platforms', old: '2 — 3', toby: 'All 5' },
                    { label: 'Brand voice', old: 'Hit or miss', toby: 'DNA-driven' },
                    { label: 'Turnaround', old: '24 — 48h', toby: 'Minutes' },
                    { label: 'Analytics', old: 'Monthly PDF', toby: 'Real-time' },
                    { label: 'Setup time', old: 'Weeks', toby: '5 minutes' },
                  ].map((row, i) => (
                    <tr key={row.label} className={`${i < 6 ? 'border-t border-zinc-100' : 'border-t border-zinc-100'}`}>
                      <td className="py-3.5 px-5 sm:px-6 text-[14px] font-medium text-zinc-700">{row.label}</td>
                      <td className="py-3.5 px-4 sm:px-6 text-[14px] text-zinc-400 text-center">{row.old}</td>
          ...
          <Reveal delay={0.2}>
            <div className="mt-10 text-center">
              <button
                onClick={() => navigate('/login')}
                className="inline-flex items-center gap-2 bg-zinc-900 hover:bg-zinc-800 text-white text-[14px] font-medium px-8 py-3 rounded-full transition-all duration-200 hover:shadow-md"
              >
                Start Free Trial
                <ArrowRight className="w-4 h-4" />
              </button>
        ...
        <div className="max-w-[640px] mx-auto">
          <Reveal>
            <div className="text-center mb-12">
              <h2 className="text-[28px] sm:text-[36px] font-bold text-zinc-900 tracking-[-0.02em]">
                Questions & answers
              </h2>
            </div>
          </Reveal>
      ...
      <section className="py-20 sm:py-28 px-5 sm:px-8 bg-white">
        <div className="max-w-[600px] mx-auto text-center">
          <Reveal>
            ...
            <p className="mt-4 text-[16px] sm:text-[18px] text-zinc-500 leading-relaxed max-w-[400px] mx-auto">
              Start creating content in minutes, not hours.
            </p>
            <div className="mt-8">
              <button
                onClick={() => navigate('/login')}
                className="inline-flex items-center gap-2 bg-zinc-900 hover:bg-zinc-800 text-white text-[15px] font-medium px-10 py-3.5 rounded-full transition-all duration-200 hover:shadow-md"
              >
                Start Free Trial
                <ArrowRight className="w-4 h-4" />
              </button>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 pb-10 border-b border-zinc-800/60">
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <p className="text-[13px] text-zinc-500 leading-relaxed">
                AI-powered content creation<br />for growing brands.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="/terms" className="text-[13px] text-zinc-500 hover:text-white transition-colors">Terms</a></li>
                <li><a href="/privacy" className="text-[13px] text-zinc-500 hover:text-white transition-colors">Privacy</a></li>
                <li><a href="/data-deletion" className="text-[13px] text-zinc-500 hover:text-white transition-colors">Data Deletion</a></li>
              </ul>
            </div>
