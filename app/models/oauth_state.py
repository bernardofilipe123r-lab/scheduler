...
class OAuthState(Base):
    ...
    platform = Column(String(20), nullable=False)       # 'instagram', 'facebook', 'youtube', 'threads', 'tiktok'
    brand_id = Column(String(100), nullable=False)
    user_id = Column(String(100), nullable=False)
    return_to = Column(String(50), nullable=True)        # 'onboarding' or None (brands page)
    code_verifier = Column(String(128), nullable=True)   # TikTok PKCE code_verifier
