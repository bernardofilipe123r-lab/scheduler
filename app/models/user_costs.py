...
class UserCostDaily(Base):
    ...
    freepik_calls = Column(Integer, default=0)
    freepik_cost_usd = Column(Float, default=0.0)
    searchapi_calls = Column(Integer, default=0)
    searchapi_cost_usd = Column(Float, default=0.0)
