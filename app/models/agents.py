"""
AI agent models: AIAgent, AgentPerformance, AgentLearning, GenePool, AgentProposal.
"""
...
class AgentProposal(Base):
    """
    A content proposal generated by an AI agent.

    Agents analyse performance data, trends, and content gaps,
    then propose reels and posts that the user can
    ...
    # Which agent created this proposal
    ...
    __table_args__ = (
        Index("ix_agent_proposals_status_created", "status", "created_at"),
    )
