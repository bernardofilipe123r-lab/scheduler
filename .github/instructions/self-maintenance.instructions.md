...
| Add/remove/change an agent | `.github/copilot-instructions.md` (Available Agents table) + `.claude/CLAUDE.md` (Available Agents table) |
| Add/remove/change a prompt | `.github/copilot-instructions.md` (Available Prompts table) + `.claude/CLAUDE.md` (Available Prompts table) |
